...
<body ng-app="pinyougou" ng-controller="itemController" ng-init="num=1;loadDefaultSku()">
	<!-- 头部栏位 -->
	<!--页面顶部-->
		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${map.category1}</a>
					</li>
					<li>
						<a href="#">${map.category2}</a>
					</li>
					<li>
						<a href="#">${map.category3}</a>
					</li>
							...
							<div class="fl">
								...
								<ul class="btn-choose unstyled">
									<li ng-if="sku.status=='1'">									   
										<a href="cart.html" target="_blank" ng-click="addGoodsToCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
